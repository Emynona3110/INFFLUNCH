...
//     on ne révèle ni l'éligibilité du domaine, ni un doublon, ni le throttle).
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Erreurs avalées volontairement (doublon 23505, throttle P0001…) → on
    // renvoie toujours le succès générique pour ne rien divulguer.
